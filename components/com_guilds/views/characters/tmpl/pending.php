...
<div class="com-guilds container-fluid">
    ...
    <div class="row-fluid">
        <div class="span2 editable-click" data-title="Edit Character Name" data-name="name" data-pk="<?php echo $invite->id; ?>"><?php echo $invite->name; ?></div>
        <?php foreach($this->types as $type):?>
            <?php $type_name = $type->name.'_name'; ?>
            <?php $type_id = $type->name.'_id'; ?>
            <div class="span2 com-guilds-<?php echo $type->name;?> editable-click category" data-title="Select Category" data-type="select" data-pk="<?php echo $invite->id; ?>" data-name="<?php echo $type->name; ?>" data-source="index.php?option=com_guilds&view=categories&format=json&type=<?php echo $type->name; ?>" data-value="<?php echo $invite->$type_id; ?>"><?php echo $invite->$type_name; ?></div>
        <?php endforeach;?>
        <div class="editable-click span2" data-type="date" data-name="checked" data-placement="right" data-title="Update Date" data-pk="<?php echo $invite->id; ?>"><?php echo $invite->checked; ?></div>
        <div class="span2"><a class="btn btn-mini" title="Invite Sent!" href="<?php echo JRoute::_('index.php?option=com_guilds&view=characters&task=invited&id='.$invite->id); ?>"><i class="icon-share"></i></a></div>
    </div>
    <?php endforeach; ?>
...
<div class="com-guilds container-fluid">
    ...
    <div class="row-fluid">
        <div class="span2 editable-click" data-title="Edit Character Name" data-name="name" data-pk="<?php echo $promotion->id; ?>"><?php echo $promotion->name; ?></div>
        <?php foreach($this->types as $type):?>
            <?php $type_name = $type->name.'_name'; ?>
            <?php $type_id = $type->name.'_id'; ?>
