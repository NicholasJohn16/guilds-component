...
<form class="form-horizontal" action="index.php" method="post">
	<div class="tab-content">
		<div class="tab-pane active" id="guilds">
				...
				<div class="controls"><input name="username" id="username" readonly="readonly" type="text" value="<?php echo $member->username; ?>"/></div>
			</div>
			<div class="control-group">
				<label class="control-label" for="sto_handle">@Handle</label>
				<div class="controls"><input name="sto_handle" id="sto_handle" type="text" value="<?php echo $member->sto_handle; ?>"/></div>
			</div>
			<div class="control-group">
				<label class="control-label" for="tor_handle">TOR Forum name</label>
				<div class="controls"><input name="tor_handle" id="tor_handle" type="text" value="<?php echo $member->tor_handle; ?>"/></div>
			</div>
                    <div class="control-group">
				<label class="control-label" for="gw2_handle">Guild Wars 2 User ID</label>
				<div class="controls"><input name="gw2_handle" id="gw2_handle" type="text" value="<?php echo $member->gw2_handle; ?>"/></div>
			</div>
		</div>
		<div class="tab-pane" id="network">
			...
			<div class="control-group">
				...
				<div class="controls">
                                    <input class="span2" name="appdate" id="appdate" type="text" value="<?php echo $member->appdate; ?>">
				</div>
			</div>
		</div>
		<div class="tab-pane" id="notes">
			<textarea name="notes" rows="3" style="width:315px;"><?php echo $member->notes ?></textarea>
		</div>
	</div>
